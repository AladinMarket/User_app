...
class BannerContents {
  ...
  BannerContents.fromJson(Map<String, dynamic> json) {
    ...
    moduleId = json['moduleId'] != null ? int.parse(json['moduleId'].toString()) : null;
    key = json['key'];
    value = json['value'];
    type = json['type'];
    status = json['status'];
...
class Translations {
  ...
  Translations.fromJson(Map<String, dynamic> json) {
    ...
    translationableId = json['translationableId'] != null ? int.parse(json['translationableId'].toString()) : null;
    locale = json['locale'];
    key = json['key'];
    value = json['value'];
    createdAt = json['created_at'];
